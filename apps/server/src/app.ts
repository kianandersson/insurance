...
import { SkeletonRpcs } from "@insurance/seam";
import { Layer } from "effect";
import { ActorMiddlewareStub } from "./actor-middleware.js";
import type { Database } from "./database.js";
import { EventBusLive } from "./event-bus.js";
import { SkeletonHandlersLive } from "./handlers.js";
import { ProjectionLive } from "./projection.js";
...
export const makeServer = <E>(options: {
	...
	const rpc = RpcServer.layer(SkeletonRpcs).pipe(
		...
		Layer.provide(ActorMiddlewareStub),
	);
